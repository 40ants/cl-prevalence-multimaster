# -*- coding: utf-8 -*-
#
# prevalence-multimaster documentation build configuration file, created by
...
cl_systems = [
    {
        'name': 'prevalence-multimaster-test',
...
project = u'prevalence-multimaster'
copyright = u'2017, '
...
htmlhelp_basename = 'prevalence-multimasterdoc'
...
latex_documents = [
  ('index', 'prevalence-multimaster.tex', u'prevalence-multimaster Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'prevalence-multimaster', u'prevalence-multimaster Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'prevalence-multimaster', u'prevalence-multimaster Documentation',
   u'', 'prevalence-multimaster', 'Addon for cl-prevalence, implementing peer to peer syncronization.',
   'Miscellaneous'),
]
